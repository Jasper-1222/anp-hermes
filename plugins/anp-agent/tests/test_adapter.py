...
@pytest.mark.asyncio
async def test_connect_success_sets_connected(platform_config, mock_identity, mock_auth):
...
@pytest.mark.asyncio
async def test_disconnect_sets_disconnected(platform_config, mock_identity, mock_auth):
    adapter = ANPAdapter(platform_config)
